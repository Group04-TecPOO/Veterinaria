	...
	public paciente_nuevo() {
		...
		contentPanel.setLayout(null);
		{
			...
			}
			{
				...
				cboSexo.setBounds(95, 143, 96, 22);
				panel1.add(cboSexo);
			}
			{
				lblNewLabel_1 = new JLabel("Sexo:");
				lblNewLabel_1.setBounds(24, 147, 46, 14);
			...
			{
				txtEdadD = new JTextField();
				txtEdadD.setColumns(10);
				txtEdadD.setBounds(95, 112, 96, 20);
				panel1.add(txtEdadD);
			}
			{
		...
		}
		{
			...
			}
			{
				...
				lblNewLabel_6.setBounds(22, 160, 119, 19);
			...
			}
			{
				...
				cboAnio.setBounds(249, 158, 64, 22);
				panel2.add(cboAnio);
			}
			{
			...
			{
				txtEspeM = new JTextField();
				txtEspeM.setColumns(10);
				txtEspeM.setBounds(102, 96, 211, 20);
				panel2.add(txtEspeM);
			}
			{
